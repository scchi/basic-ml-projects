...
# Feature selection and removing the most correlated attributes                       !!!! NOTES
...
# Test options and evaluatio metric
num_folds = 10
seed = 7
...
# scaler = StandardScaler().fit(X_train)
# rescaledX = scaler.transform(X_train)
# param_grid = dict(n_estimators=numpy.array([200, 250, 300, 350, 400]))
